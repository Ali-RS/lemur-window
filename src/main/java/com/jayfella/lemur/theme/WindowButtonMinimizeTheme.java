...
public class WindowButtonMinimizeTheme extends ButtonTheme {

    protected IconComponent icon = new IconComponent("Style/Icon/button.png");
    protected Insets3f insets = new Insets3f(5,5,5,5);
    protected float fontSize = 0.0f;

    public WindowButtonMinimizeTheme() {
        super("window-button-minimize");

        BackgroundUtils.setBackgroundColor(background, new ColorRGBA(0, 0, 0, 0));
        icon.setColor(new ColorRGBA(1.0f, 0.7412f, 0.298f, 1.0f));
